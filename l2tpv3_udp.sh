...
ip netns exec r1 ip l2tp add tunnel remote 172.16.2.253 local 172.16.1.253 encap udp tunnel_id 3000 peer_tunnel_id 4000 udp_sport 2024 udp_dport 2025
ip netns exec r2 ip l2tp add tunnel remote 172.16.1.253 local 172.16.2.253 encap udp tunnel_id 4000 peer_tunnel_id 3000 udp_sport 2025 udp_dport 2024
